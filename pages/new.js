...
export default function New() {
    return(
        <>
          <div>      
            <div className="bannerFondo bg-green-800	bg-left-top bg-auto bg-repeat-x" style={{backgroundImage: 'url(./img/continuartl_4.png)', height: 400}}>
            </div>
            <div className="-mt-64 ">
                ...
                <div className="p-2 sm:p-10 text-center cursor-pointer text-white"> 
                    ...
                    <div className="space-y-10">
                        <i className="fa fa-head-side-mask" style={{fontSize: 48}} />
                        <div className="px-6 py-4">
                        <div className="space-y-5">
                ...
                <div className="p-2 sm:p-10 text-center cursor-pointer translate-x-2">
                    <div className="py-16 max-w-sm rounded overflow-hidden shadow-lg hover:bg-white transition duration-500 bg-white ">
                    <div className="space-y-10">
                        <i className="fa fa-swimmer" style={{fontSize: 48}} />
                        <div className="px-6 py-4">
                        <div className="space-y-5">
